...
// Hàm xử lý khi người dùng nhấn vào nút Trang chủ
function tranghome_ns() {
    window.location.href = '../html/trang_homens.html'; // Chuyển hướng đến trang chủ
}

// Hàm xử lý khi người dùng nhấn vào nút Trang chủ
function tranghome_ld() {
    window.location.href = '../html/trang_homeld.html'; // Chuyển hướng đến trang chủ
}
